      ...
      <div style={{ display: 'flex', gap: '24px', alignItems: 'stretch' }}>
         ...
         <div style={{ flex: 1, background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '24px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
            ...
            <select 
               ...
               style={{ width: '100%', maxWidth: '300px', padding: '8px 12px', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.9rem', color: '#334155', background: '#f8fafc', marginBottom: '24px' }}
            >
